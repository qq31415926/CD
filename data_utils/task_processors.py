...
class FinanceProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "finance","train"), "train")

    def get_dev_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "finance","val"), "dev")

    def get_test_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "finance", "test"), "test")

    def get_unlabeled_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "unlabeled.jsonl"), "unlabeled")

    def get_dev32_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "finance","val"), "dev32")
    def get_labels(self):
    ...
    def _create_examples(self, path: str, set_type: str, hypothesis_name: str = "hypothesis",
        ...
        examples = []        
        file_path = os.path.join(path, set_type + ".csv")
        ...
        return examples
class JusticeProcessor(DataProcessor):
    def __init__(self):
        self.id2label = {0: 'majority opinion',
         1: 'per curiam',
         2: 'plurality opinion',
         3: 'equally divided',
         4: 'dismissal - moot',
         5: 'dismissal - improvidently granted',
         6: 'dismissal - other',
         7: 'opinion of the court'}
    
    def get_train_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "justice","train"), "train")

    def get_dev_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "justice","val"), "dev")

    def get_test_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "justice", "test"), "test")

    def get_unlabeled_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "unlabeled.jsonl"), "unlabeled")

    def get_dev32_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "justice","val"), "dev32")
    def get_labels(self):
      return  ['majority opinion','per curiam','plurality opinion','equally divided','dismissal - moot','dismissal - improvidently granted','dismissal - other','opinion of the court']    
    def _create_examples(self, path: str, set_type: str, hypothesis_name: str = "hypothesis",
                         premise_name: str = "premise") -> List[InputExample]:
        examples = []        
        file_path = os.path.join(path, set_type + ".csv")
        ...
        for idx, row in df.iterrows():
            # sentence, label = row.sentence, row.label
            label, sentence = row.decision_type, row.facts
            text_a = sentence
            text_b = None
            label = self.id2label[label]
        ...
        return examples
class MedicalProcessor(DataProcessor):
    def __init__(self):
        self.id2label = {
            0:"neoplasms",
    ...
    def get_train_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "medical","train"), "train")

    def get_dev_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "medical","val"), "dev")

    def get_test_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "medical", "test"), "test")

    def get_unlabeled_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "unlabeled.jsonl"), "unlabeled")

    def get_dev32_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "medical","val"), "dev32")
    def get_labels(self):
    ...
    def _create_examples(self, path: str, set_type: str, hypothesis_name: str = "hypothesis",
        ...
        for idx, row in df.iterrows():
            # sentence, label = row.sentence, row.label
            label, sentence = row.condition_label, row.medical_abstract
            text_a = sentence
            text_b = None
            label = self.id2label[label]
...
class AgnewsProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "agnews","train"), "train")

    def get_dev_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "agnews","val"), "dev")

    def get_test_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "agnews", "test"), "test")

    def get_unlabeled_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "unlabeled.jsonl"), "unlabeled")

    def get_dev32_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "agnews","val"), "dev32")
    ...
    def _create_examples(self, path: str, set_type: str, hypothesis_name: str = "hypothesis",
                         premise_name: str = "premise") -> List[InputExample]:
        examples = []        
        file_path = os.path.join(path, set_type + ".tsv")
...
class IMDBProcessor(DataProcessor):
    def get_train_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "imdb","train"), "train")

    def get_dev_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "imdb","val"), "dev")

    def get_test_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "imdb", "test"), "test")

    def get_unlabeled_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "unlabeled.jsonl"), "unlabeled")

    def get_dev32_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "imdb","val"), "dev32")
...
class SST2Processor(DataProcessor):
    def get_train_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "sst2","train"), "train")

    def get_dev_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "sst2","val"), "dev")

    def get_test_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "sst2", "test"), "test")

    def get_unlabeled_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "unlabeled.jsonl"), "unlabeled")

    def get_dev32_examples(self, data_dir):
        return self._create_examples(os.path.join(data_dir, "sst2","val"), "dev32")
